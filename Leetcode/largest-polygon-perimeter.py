...
You are given an array of positive integers nums of length n.
  ...
  polygon is smaller than the sum of its other sides.
...
Explanation: The polygon with the largest perimeter which can be made from nums 
  ...
  We cannot have a polygon with either 12 or 50 as the longest side because it is not 
  possible to include 2 or more smaller sides that have a greater sum than either of them.
